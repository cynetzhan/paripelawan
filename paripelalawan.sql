...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Des 2017 pada 16.59
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
CREATE TABLE IF NOT EXISTS `objek_wisata` (
  ...
  `kode_video` varchar(20) NOT NULL
...
(4, '14801293120312', 'Masmono', 'Mesra', '08773123123', 'masmono', '$2y$10$pVhguDaawGGxX.llw7QVyuhkvFk3M0LKZloufyKdYA7jqXp8gb3Wu', 1);
...
--
-- Struktur dari tabel `webinfo_artikel`
--
...
--
-- Dumping data untuk tabel `webinfo_artikel`
--
...
--
-- Struktur dari tabel `webinfo_kategori`
--
...
--
-- Dumping data untuk tabel `webinfo_kategori`
--
...
--
-- Struktur dari tabel `webinfo_komentar`
--
...
--
-- Dumping data untuk tabel `webinfo_komentar`
--
...
--
ALTER TABLE `objek_wisata`
  MODIFY `id_objek` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
-- Ketidakleluasaan untuk tabel `webinfo_artikel`
--
ALTER TABLE `webinfo_artikel`
...
--
-- Ketidakleluasaan untuk tabel `webinfo_komentar`
--
ALTER TABLE `webinfo_komentar`
